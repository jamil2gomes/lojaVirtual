          ...
          Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(product.price.toStringAsFixed(2), style: TextStyle( color: Theme.of(context).primaryColor, fontSize: 22.0, fontWeight: FontWeight.bold), maxLines: 3,),
                SizedBox(height: 6.0,),
                          ...
                          return GestureDetector(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: tamanho == tamanhoSelecionado? Theme.of(context).primaryColor: Colors.grey[500], width: 3.0),
